...
outputName = 'TMVAGlobal' + region + '2016' + var1 + var2 + '.root'
...
dataBdNS = TFile.Open('bankBdKxMuMu16.root')
...
if kerasFlag:
	...
	# Store model to file
	modelName = 'model' + region + '16' + var1 + var2 + '.h5'
	...
	dnnName = 'DNNGlobal' + region + '2016' + var1 + var2
...
if bdtFlag:
	...
	bdtName = 'BDTGlobal' + region + '2016' + var1 + var2
